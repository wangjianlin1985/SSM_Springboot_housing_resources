				...
				<div class="tab-content">
				    ...
				    <div role="tabpanel" class="tab-pane active" id="priceRangeAdd"> 
						  ...
						  <div class="form-group">
						  	 <label for="priceRange_rangeName" class="col-md-2 text-right">租金范围区段:</label>
						  	 <div class="col-md-8">
							    <input type="text" id="priceRange_rangeName" name="priceRange.rangeName" class="form-control" placeholder="请输入租金范围区段">
							 </div>
						  </div>
				          <div class="form-group">
