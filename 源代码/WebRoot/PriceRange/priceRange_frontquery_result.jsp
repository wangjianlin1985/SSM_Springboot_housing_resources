				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>租金范围id</td><td>租金范围区段</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=priceRange.getRangeName() %></td>
 											<td>
 												<a href="<%=basePath  %>House/frontlist?priceRangeObj.rangeId<%=priceRange.getRangeId() %>/frontshow"><i class="fa fa-info"></i>&nbsp;查看</a>&nbsp;
    ...
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
			 <label for="priceRange_rangeId_edit" class="col-md-3 text-right">租金范围id:</label>
			 <div class="col-md-9"> 
			 	<input type="text" id="priceRange_rangeId_edit" name="priceRange.rangeId" class="form-control" placeholder="请输入租金范围id" readOnly>
			 </div>
		  </div> 
		  <div class="form-group">
		  	 <label for="priceRange_rangeName_edit" class="col-md-3 text-right">租金范围区段:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="priceRange_rangeName_edit" name="priceRange.rangeName" class="form-control" placeholder="请输入租金范围区段">
			 </div>
		  </div>
		</form> 
	...
	$.ajax({
		...
		success : function (priceRange, response, status) {
			if (priceRange) {
				...
				$("#priceRange_rangeName_edit").val(priceRange.rangeName);
