...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">房源平台</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>House/frontlist">房源查询</a></li>
                <li><a href="<%=basePath %>Huxing/frontlist">户型列表</a></li>
                <li><a href="<%=basePath %>Area/frontlist">区域查看</a></li>
                <li><a href="<%=basePath %>PriceRange/frontlist">租金范围</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>House/house_userFrontAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布房源信息</a></li>
                        <li><a href="<%=basePath %>House/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我发布的房源</a></li>
